    ...
    return ListView(
      ...
      children: [
        ExpansionTile(
          ...
          children: [
            _buildExpansionTile('Agregar Usuario'),
            _buildExpansionTile('Modificar Usuario'),
            _buildExpansionTile('Ocultar Usuario'),
        ...
        ExpansionTile(
          ...
          children: [
            ...
            _buildExpansionTile('Eliminar Cartera'),
            _buildExpansionTile('Mostrar Cartera'),
          ],
        ),
      ],
    );
                  ...
                  onPressed: () {
                    if (_formKey.currentState?.validate() ?? false) {
                      ...
                      ScaffoldMessenger.of(context).showSnackBar(
                        const SnackBar(content: Text('Cartera creada exitosamente')),
                      );
                    }
                  },
            ...
            return Column(
              children: [
                DropdownButtonFormField<String>(
                  ...
                  onChanged: (value) {
                    if (value != null) {
                      final selectedCartera = carteras.firstWhere((doc) => doc['nombre'] == value).data() as Map<String, dynamic>;
                  ...
                  decoration: const InputDecoration(labelText: 'Seleccionar Cartera'),
                ),
                Padding(
                  padding: const EdgeInsets.all(16.0),
                  child: Form(
                        ...
                        ElevatedButton(
                          onPressed: () {
                            if (_formKey.currentState?.validate() ?? false) {
                              ...
                              ScaffoldMessenger.of(context).showSnackBar(
                                const SnackBar(content: Text('Cartera modificada exitosamente')),
                              );
                            }
                          },
