...
class CarritoStateNotifier extends StateNotifier<List<Cartera>> {
  ...
  void agregarProducto(Cartera producto) {
    ...
    if (!encontrado) {
      carritoAux.add(Cartera(nombre: producto.nombre, precio: producto.precio, imagen: producto.imagen, modelo: producto.modelo, cantidad: 1, stock: producto.stock, descripcion: producto.descripcion));
    }
    state = carritoAux;
  }
